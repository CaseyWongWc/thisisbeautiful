...
public class StandardItemEditorPanel extends BaseEditorPanel<Item> {
    ...
    private void updateDifficultiesField() {
        ...
        for (int i = 1; i <= 10; i++) {
            if (difficultyCheckboxes.get(i).isSelected()) {
        ...
        if(difficulties != null && !difficulties.isEmpty()){
            ...
            for(String diff : diffArray){
                try{
                    ...
                    difficultyCheckboxes.get(diffInt).setSelected(true);
        ...
        if (selectedName != null) {
            ...
            if (confirm == JOptionPane.YES_OPTION) {
                ...
                if (currentFile != null) {
                    ...
                    if (file.exists()) {
                        if (file.delete()) {
                            System.out.println("Deleted item file: " + currentFile);
                        } else {
                            System.err.println("Failed to delete item file: " + currentFile);
                        }
                    }
                    currentFile = null;
