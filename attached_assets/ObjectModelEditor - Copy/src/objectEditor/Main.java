...
public class Main {
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> {
            ...
            frame.setSize(1024, 768);  // Larger size for better viewing
            ...
            TerrainEditorPanel terrainPanel = new TerrainEditorPanel();
            tabbedPane.addTab("Terrain", terrainPanel);
            
            CellDemoPanel cellDemoPanel = new CellDemoPanel();
            tabbedPane.addTab("Cell Demo", cellDemoPanel);
